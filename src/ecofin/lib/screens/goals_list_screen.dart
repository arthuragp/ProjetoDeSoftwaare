            ...
            builder: (context, goalSnapshot) {
              ...
              for (var goal in goals) {
                ...
                final relevantTransactions = allTransactions.where((t) {
                  // A categoria da transação deve ser IGUAL à categoria da meta
                  return t.category == goal.category &&
                         t.date.isBefore(goal.deadline) &&
                         // Considera apenas transações do mês/ano da meta
                         t.date.year == goal.deadline.year &&
                         t.date.month == goal.deadline.month;
                });
